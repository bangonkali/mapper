      ...
      for (let j = 0; j < rows; j++) {
        for (let k = 0; k < cols; k++) {
          ...
          const annotation: Annotation = {
            ...
            canvasId: canvasId,
            title: `Image ${i} Annotation ${annotationIndex++}`,
            description: `Description for image ${i} annotation ${annotationIndex}`,
            fill: {
              alpha: 0.5,
